...
use crate::contamination_subtract::run_contamination_subtract;
...
Correction/search windows:
  ...
  --contamination-subtract MODEL_NPZ
                            apply flux model to --input .cor; alias --contamisubt
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    if let Some(model_path) = &args.contamination_subtract {
        let input_path = args
            .input
            .as_ref()
