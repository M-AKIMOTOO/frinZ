...
Correction/search windows:
  ...
  --rayleigh-count N        histogram tail count; larger N lowers the RFI threshold (default: 1)
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    if args.rayleigh_count == 0 {
        return Err("--rayleigh-count must be at least 1".into());
    }
